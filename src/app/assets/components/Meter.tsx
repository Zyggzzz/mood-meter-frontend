    ...
    <main>
      ...
      >
        ...
        <button
          ...
          className="col-span-2 col-start-2 row-start-4 m-2 border-2 border-whiteBg bg-blackPrimary px-6 py-2 text-lg font-semibold text-whiteBg shadow-md transition-all duration-200 ease-in-out hover:bg-redAccent hover:text-whiteBg focus:outline-none focus:ring-2 focus:ring-purpleAccent focus:ring-offset-2"
        >
          Ok
        </button>
      </div>
